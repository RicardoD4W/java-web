...
public class DAOManager {
    ...
    private DAOManager() {
        this.conn = null;
        this.URL = "jdbc:mysql://127.0.0.1:3307/practicaTema7y8"; // Dirección del servidor y de BD a usar
    ...
    // Si lo tiene, devuelve null para que no se creen más objetos de la clase DAO.DAOManager.
